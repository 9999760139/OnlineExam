...
const LiveTest = () => {
  ...
  const handleReview = () => {
    ...
    if (!ans_filter_id.includes(Number(question_id))) {
      ...
      answers[index].review === false
    ) {
      const option = answers[index].option;
    ...
    >
      ...
      >
        <div className={styles.mobile_sid_header}>
          ...
          <CancelOutlinedIcon onClick={toggleDrawer(anchor, false)} />
        </div>
      ...
      <div className={styles.right_question_div}>
        {questions.map((val, i) => {
          ...
          if (
            answers[ans_filter_id.indexOf(val._id)] &&
            answers[ans_filter_id.indexOf(val._id)].answered === true
          ) {
            return (
              <IconButton
                size="large"
                ...
                aria-controls="menu-appbar"
                aria-haspopup="true"
                sx={{ backgroundColor: "greenyellow", fontSize: "17px" }}
            ...
            answers[ans_filter_id.indexOf(val._id)] &&
            answers[ans_filter_id.indexOf(val._id)].not_answered === true
          ) {
            return (
              <IconButton
                size="large"
            ...
            answers[ans_filter_id.indexOf(val._id)] &&
            answers[ans_filter_id.indexOf(val._id)].review === true
          ) {
            return (
              <IconButton
                size="large"
                ...
                aria-controls="menu-appbar"
                aria-haspopup="true"
                sx={{ backgroundColor: "rgb(134, 113, 251)", fontSize: "17px" }}
                onClick={() => handleClickQuestionNumber(i, val._id)}
                className={styles.question_number}
              >
                {i + 1}
            ...
            answers[ans_filter_id.indexOf(val._id)] &&
            answers[ans_filter_id.indexOf(val._id)].ans_review === true
          ) {
            return (
              <IconButton
                size="large"
        ...
        <div className={styles.notify_sign}>
          ...
          <div>
            <div className={styles.answer_mark_color}>
              <div className={styles.mark_ans}></div>
            </div>
  ...
  const list_left = (anchor) => (
    ...
    >
      ...
      <Typography variant="h6" sx={{ fontFamily: "DM Sans", p: 1 }}>
        By Changing Section , you will be shifted to new section. if you are
        sure about section change select any from blow.
      </Typography>
      <hr />
      <div
        onClick={() => handleSection("mathematics")}
        className={styles.selected_section}
      >
        <Typography
          variant="h5"
          sx={{ fontFamily: "DM Sans", p: 1 }}
          name="mathematics"
        >
          Mathematics
        </Typography>
      ...
      <hr />
      <div
        onClick={() => handleSection("chemistry")}
        className={styles.selected_section}
      >
        <Typography
          variant="h5"
      ...
      <div
        className={styles.change_section_btn}
  ...
  const a =
    answers && answers.filter((val) => questions[liveQuestion]._id === val._id);
  ...
  return (
    <div>
      ...
      {open.submit ? (
        <Modals handleClose={handleSubmit} open={open.submit} type="submit" />
      ) : (
        ""
      )}
      <Drawer
      ...
      <Box className={styles.flex_div}>
        <Box className={sidebar ? styles.left_div : styles.left_div_side}>
          <div className={styles.subject_btn_div}>
            <Button variant="outlined">
              {section.updated === "mathematics"
                ? "MATHMATICS"
                : section.updated === "physics"
                ? "PHYSICS"
                : "CHEMISTRY"}
            </Button>
            <Button
              ...
              return (
                <>
                  <div key={val._id} className={styles.question_div}>
                    <div className={styles.subject_btn_div}>
                      <p className={styles.question_no}>
                        {" "}
                        Q.{liveQuestion + 1} of {questions.length}{" "}
                      </p>
                      Marks
                      <span className={styles.positive_marking}>4.0,</span>-1.0
                    </div>
                    <Typography
                      variant="h6"
                      sx={{
                    ...
                    >
                      If the order of Matrix A is xp ,and the order of p*n.Then
                      the order of matrix Ab is ? {val.question}
                    </Typography>
                  </div>
                  {val.image && (
                    <img
                      className={val.image && styles.question__Image}
                    ...
                    {val.options.map((vl, i) => (
                      <>
                        <RadioGroup
                          ...
                          sx={{ display: "flex" }}
                          value={answers
                            .filter((v) => Number(v._id) === Number(val._id))
        ...
        {sidebar ? (
                ...
                if (
                  ...
                  return (
                    <IconButton
                      ...
                      aria-haspopup="true"
                      sx={{
                        backgroundColor: "rgb(134, 113, 251)",
                        fontSize: "17px",
                      }}
                      onClick={() => handleClickQuestionNumber(i, val._id)}
                      className={styles.question_number}
          ...
          <div
            className={styles.toggle_btn_true}
